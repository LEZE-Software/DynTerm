...
namespace Game
{
    public partial class Form_Center : Form
    {
        ...
        {
            Props.localPort.PortName = "COM7";
            Props.localPort.BaudRate = 9600;

            Props.localPort.Open();

            Props.localPort.DataReceived += new SerialDataReceivedEventHandler(this.DataReceivedHandler);
        }

        private void cmd_closePort_Click(object sender, EventArgs e)
        {
            Props.localPort.Close();
        }
